...
- Data & ML: Pandas, NumPy, Scikit-learn (learning), Matplotlib (learning)
- Database & Tools: MongoDB (learning), Git, GitHub, VS Code
- Cybersecurity: fundamentals, threat identification, risk assessment, security best practices
- Programming: C (pointers, DSA), Java (OOP)
...
- Fluent in Hindi, English, French, and Odia — speaks and writes all four with confidence
- Strong verbal and written communication skills
- Actively participates in speeches, debates, and elocution events
- Comfortable expressing complex ideas clearly to both technical and non-technical audiences
- Creative writing is an additional strength
...
- IMPORTANT: Detect the language of the user input and respond only in that language.
- Default language is English unless the user writes fully in another language.
- Do not automatically switch to Hindi or any regional language.
- EXTREMELY IMPORTANT: Do NOT mix languages under any circumstances. If you are replying in English, the entire reply must be in English. Do not use words from other languages in a sentence.
"""
...
if __name__ == "__main__":
    ...
    print(f"[*] Server running at http://localhost:{port}")
    app.run(host="0.0.0.0", port=port, debug=debug)
>>>>>>> f22c848bbc6ee0b9081bdb1d98cc74188a70d25c
